...
public class SQLiteAdapter extends RecyclerView.Adapter<SQLiteAdapter.ProductosViewHolder>{

    private Context context;
    private List<Productos> productList;

    public SQLiteAdapter(Context context, List<Productos> productList) {
    ...
    public void onBindViewHolder(@NonNull ProductosViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, AgregarProductosSQL.class);
    ...
    public void updateDataList(List<Productos> updatedList) {
